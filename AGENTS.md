...
- `llamacpp-models.ini` — gitignored. llama-server model preset file. Used when any LLM entry has `runtime = "llamacpp"` and by the standalone `./start-llamacpp.sh` launcher. Copy from `llamacpp-models.ini.example`.
